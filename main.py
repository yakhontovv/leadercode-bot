...
TXT = {
    "ru": {
        ...
        "intro_own": ("<b>Код руководителя</b> - игра-симуляция от YES•GROUP.\n\n"
                      "За 3 минуты вы проживёте один рабочий день: 8 обычных ситуаций. "
                      "В каждой выбираете, как поступили бы на самом деле, а не как правильно.\n\n"
                      "По ответам бот соберёт ваш управленческий код по модели Ицхака Адизеса - "
                      "в чём вы сильны и кого не хватает команде. Плохих кодов нет: у каждого "
                      "сильны 1-2 из четырёх.\n\nГотовы? День начинается в 9:00."),
        "intro_inv": ("<b>Код руководителя</b> - игра-симуляция от YES•GROUP.\n\n"
                      ...
                      "За 3 минуты вы проживёте один рабочий день: 8 ситуаций. В каждой выбирайте, "
        ...
        "back": "← Назад",
        "flat": ("<b>Ровный профиль</b>\n\nТак почти не бывает у живого руководителя. "
                 "Обычно это значит, что ответы были «как правильно», а не «как есть». "
                 "Пройдите день ещё раз - вспоминая, как было на самом деле: /start\n\n{sign}"),
        ...
        "forecast_anchor": "Из практики 497 проектов YES•GROUP",
        ...
        "reminder": ("Карта команды ждёт: вчера вы взяли ссылку для топов, но пока никто не прошёл. "
        ...
        "team_note": ("Карта показывает предпочтения людей, а не их ценность. Дырка в коде - задача "
                      "на найм или усиление, не приговор команде."),
        "team_multi": "Несколько бизнесов? В этой версии - карта одной ключевой команды.",
        "team_atlas": "Принесите карту на встречу 6 (13.07) + одно решение по одной дыре.",
        "team_empty": "Карта пока пустая. Сначала пройдите день сами: /start",
        "team_invite_more": "Пригласить ещё",
    },
    "en": {
        "scenes": SCENES_EN,
...
def build_result(s, lang, subject="self", subject_name="", source="site"):
    ...
    if flat:
        return t["flat"].format(sign=t["sign"]), prof, dom
